...
<div class="row mt-4">
    <div class="col-6">
        ...
        <div class="form-group">
            <?= $this->Form->label('income_type_id') ?>
            <?php if ($this->Form->isFieldError('income_type_id')): ?>
                <span class="badge badge-danger">Error</span>
            <?php endif; ?>
            <?= $this->Form->select('income_type_id', $types->combine('id', 'name'), ['class' => 'form-control']) ?>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <?= $this->Html->link('Back', ['controller' => 'Incomes', 'action' => 'index'], ['class' => 'btn btn-secondary ml-2']) ?>
        </div>
        <?= $this->Form->end() ?>
    </div>
</div>